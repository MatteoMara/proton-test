            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Contact data with missing blob references</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        $contactDataErrors = getContactDataErrors();

                                        if ($contactDataErrors->num_rows > 0) {
                                            // output data of each row
                                            while ($row = $contactDataErrors->fetch_assoc()) {
