    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#messages" aria-expanded="false"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#attachments" aria-expanded="false"
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Blob reference errors</h4>
                                <p class="card-description">
                                    Blobs with a number of references different from the table content.
                                </p>
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                Number of references (Table value)
                                            </th>
                                            <th>
                                        ...
                                        $blobReferenceErrors = getBlobsWithWrongReferences();

                                        if ($blobReferenceErrors->num_rows > 0) {
                                            // output data of each row
                                            while ($row = $blobReferenceErrors->fetch_assoc()) {
                                                echo "<tr><td><a href='blobDetail.php?blobId=" . $row["BlobStorageId"] . "'>" . $row["BlobStorageId"] . "</a></td><td>" . $row["NumReferences"] . "</td><td>" . $row["RealCount"] . "</td></tr>";
                                            }
                                            echo "</table>";
                                        } else {
                                            echo "0 results";
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Items with missing blob references</h4>
                                <p class="card-description">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            <th>Entity ID</th>
                                            <th>Entity Type</th>
                                            <th>Missing Blob ID</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php

                                        $missingBlob = getItemsWithMissingBlob();

                                        if ($missingBlob->num_rows > 0) {
                                            // output data of each row
                                            while ($row = $missingBlob->fetch_assoc()) {
