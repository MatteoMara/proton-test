            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Blob Details</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        <?php
                                        include '../../blobDetails.php';

                                        if (isset($_GET['blobId'])){

                                            $blobId = $_GET['blobId'];

                                            $blobDetails = getBlobDetails($blobId);

                                            if ($blobDetails->num_rows > 0) {
                                                // output data of each row
                                                while ($row = $blobDetails->fetch_assoc()) {
                                                    echo "<tr><td>" . $row["BlobStorageId"] . "</td><td><b>" . $row["NumReferences"] . "</b></td><td>" . $row["Type"]. "</td><td>" . $row["Version"] . "</td><td>" . $row["Size"] . "</td><td>" . $row["ShardId"]. "</td></tr>";
                                                }
                                                echo "</table>";
                                            } else {
                                                echo "Blob not found!";
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Blob References in the DB</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <thead>
                                        <tr>
                                        ...
                                        if (isset($_GET['blobId'])){
                                            ...
                                            $blobReferences = getBlobReferences($blobId);

                                            if ($blobReferences->num_rows > 0) {
                                                // output data of each row
                                                while ($row = $blobReferences->fetch_assoc()) {
                                                    echo "<tr><td>" . $row["EntityId"] . "</td><td>" . $row["EntityDesc"] . "</td><td>" . $row["BlobId"] . "</td></tr>";
                                                }
                                                echo "</table>";
                                            } else {
                                                echo "0 results";
